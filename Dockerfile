...
RUN for i in arm-any32-linux-musleabi mips-any32-linux-musl mipsel-any32-linux-musl; do wget -qO- https://github.com/dimkr/toolchains/releases/latest/download/$i.tar.gz | tar -xzf - -C /; done
